...
| **Discovery** | **Mandatory before spec.** Ask clarifying questions one at a time (or state assumptions), then fill the **required checklist**: goal, audience, success criteria, non-goals, constraints/risks. `discover --complete` refuses until all five are recorded (use `--force-complete` only for trivial / skip-FF features). | `discover --slug <slug> --question "..." --recommendation "..." --rationale "..."` (repeat), then `discover --slug <slug> --goal "..." --audience "..." --acceptance-criteria "..." --non-goal "..." --constraints "..." --summary "..." --complete` |
