# Feasibility-adversarial review — spec revision 3

Lens: can this design actually be built and run in *this* repo? Round-1 and
round-2 findings are excluded. Everything below is new to revision 3's redesign.
