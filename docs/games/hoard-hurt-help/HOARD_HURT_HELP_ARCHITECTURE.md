...
| `hoard_hurt_help/rules.py` | 86 | PD constants (incl. the betrayal‑sting and mutual‑help‑decay values) + the rules text the agent sees (`semantic_rules_text` / payoff table). |
