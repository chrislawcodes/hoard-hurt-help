...
PHRASES: dict[str, dict[str, str]] = {
    "propose_partnership": {
        "honest": "{target_name}, I want to try a mutual-help lane.",
        ...
        "false": "{target_name}, I am not choosing a partner yet.",
    },
    "confirm_partner": {
        "honest": "{target_name}, I am staying with you this turn.",
    ...
    "ask_truce": {
        "honest": "{target_name}, I want a truce this turn.",
    ...
    "warn_attacker": {
        "honest": "{target_name} hurt me, so I am watching them closely.",
    ...
    "warn_leader": {
        "honest": "{target_name} is too far ahead, so I may hurt them.",
    ...
    "claim_score_focus": {
        ...
        "false": "I am helping someone this turn.",
    },
    "observe_table": {
    ...
    "mislead_intent": {
        ...
        "false": "I am definitely helping {target_name}.",
    },
}
...
def render_phrase(
    ...
    *,
    ...
    phrase = phrases.get(truth_mode, phrases["quiet"])
