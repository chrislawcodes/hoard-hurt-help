...
async def list_agents(
    ...
    for agent, version in agents:
        ...
        # One shared readiness→badge mapping, also used by the agent detail page
        # (app/routes/agents_detail.py), so the two pages can't disagree about
        # whether the same agent is ready.
