...
LD_STRATEGY_PRESETS: list[StrategyPreset] = [
    StrategyPreset(
        ...
        prompt=(
            ...
            "When you're trapped (forced to bid the impossible):\n"
            "- Challenge instead of making an obvious lie. A honest challenge is better than a desperate bluff.\n"
            "- If the previous bid was reasonable, they probably weren't lying — but challenge anyway if you have no legal honest move.\n\n"
            "Endgame:\n"
    ...
    StrategyPreset(
        ...
        prompt=(
            ...
            "When you're trapped (forced to bid the impossible):\n"
            "- Make a plausible bluff, not the boldest one. If the bid is at 10, bid 11—something that sounds reasonable.\n"
            "- Your confidence and history of successful bluffs will carry you. A reasonable-looking lie beats an obvious one.\n\n"
            "Endgame:\n"
    ...
    StrategyPreset(
        ...
        prompt=(
            ...
            "When you're trapped (no legal honest bid exists):\n"
            "- Calculate: Is challenging better odds than bluffing? If the previous bid's probability is above 60%, challenge (you're probably losing anyway).\n"
            "- If the probability is borderline (40-60%), consider a minimal bluff rather than challenge — at least you stay alive.\n\n"
            "Endgame:\n"
    ...
    StrategyPreset(
        ...
        prompt=(
            ...
            "When you're trapped (no legal honest bid exists):\n"
            "- Think about who made the previous bid. If they're usually truthful, challenge. If they bluff often, bluff back.\n"
            "- If the cautious player bid high, they might actually have it — challenge to eliminate them early.\n"
            "- If the aggressive player bid, they might be bluffing too — risk a counter-bluff.\n\n"
            "Late game: Dominate.\n"
