...
def _arrange(monkeypatch: pytest.MonkeyPatch, *, prod: bool, client_id: str, client_secret: str, base_url: str) -> None:
...
def test_local_dev_missing_creds_warns_not_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    _arrange(monkeypatch, prod=False, client_id="", client_secret="", base_url="http://localhost:8000")
