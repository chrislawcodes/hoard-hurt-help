...
async def test_agent_runner_scripts_are_served(client: AsyncClient) -> None:
    c = client
...
async def test_retired_provider_setup_scripts_are_not_served(client: AsyncClient) -> None:
...
async def test_connections_page_shows_inline_setup_instructions(
